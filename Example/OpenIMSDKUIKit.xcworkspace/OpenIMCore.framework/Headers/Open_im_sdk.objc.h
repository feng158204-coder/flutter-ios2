// Objective-C API for talking to github.com/TOIM/TOIM-sdk-core/v3/TOIM_sdk Go package.
//   gobind -lang=objc github.com/TOIM/TOIM-sdk-core/v3/TOIM_sdk
//
// File is generated by gobind. Do not edit.

#ifndef __TOIM_sdk_H__
#define __TOIM_sdk_H__
...
@class TOIM_sdkLoginMgr;

@interface TOIM_sdkLoginMgr : NSObject <goSeqRefInterface> {
}
...
FOUNDATION_EXPORT const int64_t TOIM_sdkLogged;
FOUNDATION_EXPORT const int64_t TOIM_sdkLogging;
FOUNDATION_EXPORT const int64_t TOIM_sdkLogoutStatus;
FOUNDATION_EXPORT NSString* _Nonnull const TOIM_sdkLogoutTips;

@interface TOIM_sdk : NSObject
 ...
 */
+ (TOIM_sdkLoginMgr* _Nullable) userForSDK;
+ (void) setUserForSDK:(TOIM_sdkLoginMgr* _Nullable)v;

@end

FOUNDATION_EXPORT void TOIM_sdkAcceptFriendApplication(id<TOIM_sdk_callbackBase> _Nullable callback, NSString* _Nullable operationID, NSString* _Nullable userIDHandleMsg);
