// Objective-C API for talking to github.com/TOIM/TOIM-sdk-core/v3/TOIM_sdk_callback Go package.
//   gobind -lang=objc github.com/TOIM/TOIM-sdk-core/v3/TOIM_sdk_callback
//
// File is generated by gobind. Do not edit.

#ifndef __TOIM_sdk_callback_H__
#define __TOIM_sdk_callback_H__
...
@protocol TOIM_sdk_callbackBase;
@class TOIM_sdk_callbackBase;
@protocol TOIM_sdk_callbackOnAdvancedMsgListener;
@class TOIM_sdk_callbackOnAdvancedMsgListener;
@protocol TOIM_sdk_callbackOnBatchMsgListener;
@class TOIM_sdk_callbackOnBatchMsgListener;
@protocol TOIM_sdk_callbackOnConnListener;
@class TOIM_sdk_callbackOnConnListener;
@protocol TOIM_sdk_callbackOnConversationListener;
@class TOIM_sdk_callbackOnConversationListener;
@protocol TOIM_sdk_callbackOnCustomBusinessListener;
@class TOIM_sdk_callbackOnCustomBusinessListener;
@protocol TOIM_sdk_callbackOnFriendshipListener;
@class TOIM_sdk_callbackOnFriendshipListener;
@protocol TOIM_sdk_callbackOnFriendshipListenerSdk;
@class TOIM_sdk_callbackOnFriendshipListenerSdk;
@protocol TOIM_sdk_callbackOnGroupListener;
@class TOIM_sdk_callbackOnGroupListener;
@protocol TOIM_sdk_callbackOnListenerForService;
@class TOIM_sdk_callbackOnListenerForService;
@protocol TOIM_sdk_callbackOnMessageKvInfoListener;
@class TOIM_sdk_callbackOnMessageKvInfoListener;
@protocol TOIM_sdk_callbackOnSignalingListener;
@class TOIM_sdk_callbackOnSignalingListener;
@protocol TOIM_sdk_callbackOnUserListener;
@class TOIM_sdk_callbackOnUserListener;
@protocol TOIM_sdk_callbackSendMsgCallBack;
@class TOIM_sdk_callbackSendMsgCallBack;
@protocol TOIM_sdk_callbackUploadFileCallback;
@class TOIM_sdk_callbackUploadFileCallback;
@protocol TOIM_sdk_callbackUploadLogProgress;
@class TOIM_sdk_callbackUploadLogProgress;

@protocol TOIM_sdk_callbackBase <NSObject>
 - (void)onError:(int32_t)errCode errMsg:(NSString* _Nullable)errMsg;
 - (void)onSuccess:(NSString* _Nullable)data;
@end

@protocol TOIM_sdk_callbackOnAdvancedMsgListener <NSObject>
